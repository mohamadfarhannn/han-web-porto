<template>
  <section id="work" class="py-20 px-4 sm:px-8 lg:px-12 pt-34 font-sans">
    <div class="max-w-300 w-full mx-auto">
      
      <!-- Header Section -->
      <div class="flex items-center mb-16 md:mb-24 w-full">
        <!-- Small Icon Box -->
      ...
      <div class="relative">
        <div 
          ...
          :key="project.title"
          class="mb-12 md:mb-16 last:mb-0"
        >
          <HomeWorkCard 
            :title="project.title"
      ...
      <div class="mt-20 flex justify-center">
        <NuxtLink to="/projects" class="bg-yellow border-4 border-black px-8 py-3 md:py-4 font-black text-lg md:text-xl uppercase tracking-wider shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-y-1 hover:translate-x-1 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all flex items-center gap-3 no-underline text-black">
          SEE ALL WORKS
